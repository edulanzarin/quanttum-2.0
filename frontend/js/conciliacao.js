...
function populateRazaoSocial() {
  ...
  razaoSocialSelect.innerHTML =
    '<option value="" disabled selected>Selecione a Razão Social</option>';
...
function populateNomeBanco() {
  ...
  nomeBancoSelect.innerHTML =
    '<option value="" disabled selected>Selecione o Nome Banco</option>';
